...
4. The development in WX is done with WXML a programming language designed specifically for Wohola X coding. It is an enhanced version of HTML so HTML/CSS developers can build most of the solution without knowledge of other programming languages, technical platforms, databases or software architecture.
